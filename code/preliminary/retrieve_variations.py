...
if __name__ == "__main__":
    ...
    queries = pd.read_csv(f"data/query_variants/{args.collection}/w2v.csv", sep=";", header=None, names=["query_id", "text"])
    ...
    run.to_csv(f"data/w2v_runs/{args.collection}_{args.encoder}_w2v.tsv", header=False, index=False, sep="\t")
